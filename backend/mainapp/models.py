...
class ParentModel(models.Model):
    """
    created - поле дата создания
    updated = поле дата редактирования
    title = поле название строки в таблице
    status_active = статус активности
    status_delete = статус удаления из базы
    owner = автор записи-пользователь системы
...
class PassportPerson(ParentModel):
    ...
    date = models.DateField(verbose_name='Дата получения', null=True, blank=True)
